 ...
 */
public class ListedViewAdapter extends RecyclerView.Adapter<ListedViewAdapter.ViewHolder> {

    private final List<DummyItems.DummyObject> mValues;

    public ListedViewAdapter(List<DummyItems.DummyObject> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_listed_row, parent, false);
